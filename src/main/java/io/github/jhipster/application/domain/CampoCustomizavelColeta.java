...
/**
 * A CampoCustomizavelColeta.
 */
@Entity
@Table(name = "campo_customizavel_coleta")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class CampoCustomizavelColeta implements Serializable {
    ...
    public CampoCustomizavelColeta stringCustomizado1(String stringCustomizado1) {
    ...
    public CampoCustomizavelColeta stringCustomizado2(String stringCustomizado2) {
    ...
    public CampoCustomizavelColeta stringCustomizado3(String stringCustomizado3) {
    ...
    public CampoCustomizavelColeta stringCustomizado4(String stringCustomizado4) {
    ...
    public CampoCustomizavelColeta stringCustomizado5(String stringCustomizado5) {
    ...
    public CampoCustomizavelColeta stringCustomizado6(String stringCustomizado6) {
    ...
    public CampoCustomizavelColeta stringCustomizado7(String stringCustomizado7) {
    ...
    public CampoCustomizavelColeta stringCustomizado8(String stringCustomizado8) {
    ...
    public CampoCustomizavelColeta stringCustomizado9(String stringCustomizado9) {
    ...
    public CampoCustomizavelColeta stringCustomizado10(String stringCustomizado10) {
    ...
    public CampoCustomizavelColeta intCustomizado1(BigDecimal intCustomizado1) {
    ...
    public CampoCustomizavelColeta intCustomizado2(BigDecimal intCustomizado2) {
    ...
    public CampoCustomizavelColeta intCustomizado3(BigDecimal intCustomizado3) {
    ...
    public CampoCustomizavelColeta intCustomizado4(BigDecimal intCustomizado4) {
    ...
    public CampoCustomizavelColeta intCustomizado5(BigDecimal intCustomizado5) {
    ...
    public CampoCustomizavelColeta intCustomizado6(BigDecimal intCustomizado6) {
    ...
    public CampoCustomizavelColeta intCustomizado7(BigDecimal intCustomizado7) {
    ...
    public CampoCustomizavelColeta intCustomizado8(BigDecimal intCustomizado8) {
    ...
    public CampoCustomizavelColeta intCustomizado9(BigDecimal intCustomizado9) {
    ...
    public CampoCustomizavelColeta intCustomizado10(BigDecimal intCustomizado10) {
    ...
    public CampoCustomizavelColeta binCustomizado1(Boolean binCustomizado1) {
    ...
    public CampoCustomizavelColeta binCustomizado2(Boolean binCustomizado2) {
    ...
    public CampoCustomizavelColeta binCustomizado3(Boolean binCustomizado3) {
    ...
    public CampoCustomizavelColeta cliente(Cliente cliente) {
    ...
    public boolean equals(Object o) {
        ...
        CampoCustomizavelColeta campoCustomizavelColeta = (CampoCustomizavelColeta) o;
        if (campoCustomizavelColeta.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), campoCustomizavelColeta.getId());
    }
