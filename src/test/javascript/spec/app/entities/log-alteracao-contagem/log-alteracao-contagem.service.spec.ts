...
describe('Service Tests', () => {
    ...
    describe('LogAlteracaoContagem Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LogAlteracaoContagemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/log-alteracao-contagems';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LogAlteracaoContagem', () => {
