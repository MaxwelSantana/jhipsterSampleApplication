...
describe('Service Tests', () => {
    ...
    describe('CampoCustomizavelCadastro Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CampoCustomizavelCadastroService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/campo-customizavel-cadastros';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CampoCustomizavelCadastro', () => {
