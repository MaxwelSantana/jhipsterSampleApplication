...
describe('Component Tests', () => {
    ...
    describe('Secao Management Dialog Component', () => {
        let comp: SecaoDialogComponent;
        let fixture: ComponentFixture<SecaoDialogComponent>;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(SecaoDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(SecaoDialogComponent);
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'secaoListModification', content: 'OK'});
