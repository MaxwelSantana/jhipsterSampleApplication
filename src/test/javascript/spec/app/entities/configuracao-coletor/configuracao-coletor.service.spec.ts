...
describe('Service Tests', () => {
    ...
    describe('ConfiguracaoColetor Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ConfiguracaoColetorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/configuracao-coletors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ConfiguracaoColetor', () => {
