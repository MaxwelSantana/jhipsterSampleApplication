...
describe('Service Tests', () => {
    ...
    describe('CampoCustomizavelColeta Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CampoCustomizavelColetaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/campo-customizavel-coletas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CampoCustomizavelColeta', () => {
