...
describe('Service Tests', () => {
    ...
    describe('LogStatusInventario Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LogStatusInventarioService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/log-status-inventarios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LogStatusInventario', () => {
